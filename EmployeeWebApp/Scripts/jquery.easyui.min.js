...
(function ($) {
    ...
    $.fn.radiobutton.defaults = {
        width: 20, height: 20, value: null, disabled: false, readonly: false, checked: false, label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_517) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.checkbox.defaults = {
        width: 20, height: 20, value: null, disabled: false, readonly: false, checked: false, label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_53d) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    function _749(_74a) {
        ...
        if (opts.pagination) {
            ...
            _752.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_753, _754) {
    ...
    function _761(_762) {
        ...
        _767.each(function () {
            $(this).resizable({
                handles: _768, edge: opts.resizeEdge, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _763.resizing = true;
...
(function ($) {
    ...
    function _965(_966) {
        ...
        $(_966).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_968, row) {
...
(function ($) {
    function _9cb(_9cc) {
        ...
        if (opts.pagination) {
            ...
            _9d8.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_9d9, _9da) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, animate: false, singleSelect: true, view: _a71, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _9e6(true), mouseout: _9e6(false), click: _9e8 }), loader: function (_aaf, _ab0, _ab1) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
...
(function ($) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _ac1, textFormatter: function (_add, row) {
            return _add;
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _af2, keydown: _af6, paste: _af6, drop: _af6, blur: _af9 }, panelEvents: {
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupPosition: "static", groupField: null, groupFormatter: function (_b83) {
            return _b83;
        }, mode: "local", method: "post", url: null, data: null, queryParams: {}, showItemIcon: false, limitToList: false, unselectedValues: [], mappingRows: [], view: _b7d, keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
...
(function ($) {
    function _bc2(_bc3) {
        ...
        var grid = _bc4.grid;
        $(_bc3).addClass("combogrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
...
(function ($) {
    function _c06(_c07) {
        ...
        $(_c07).addClass("combotreegrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
        ...
        _c08.grid.treegrid($.extend({}, opts, {
...
(function ($) {
    function _c32(_c33) {
        ...
        $(_c33).addClass("tagbox-f").combobox($.extend({}, opts, {
            cls: "tagbox", reversed: true, onChange: function (_c35, _c36) {
                _c37();
    ...
    $.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
        hasDownArrow: false, multiple: true, reversed: true, selectOnNavigation: false, tipOptions: $.extend({}, $.fn.textbox.defaults.tipOptions, { showDelay: 200 }), val: function (_c64) {
...
(function ($) {
    function _c6b(_c6c) {
        ...
        $(_c6c).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _c6e(this);
                _c6f(this);
                _c70(this);
        ...
        if (!_c6d.calendar) {
            ...
            $.extend(_c6d.calendar.calendar("options"), {
...
(function ($) {
    function _c97(_c98) {
        ...
        $(_c98).datebox("calendar").calendar({
            onSelect: function (date) {
...
(function ($) {
    ...
    function _cca(_ccb) {
        ...
        _ccd.find("a.slider-handle").draggable({
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_cf3) {
            return _cf3;
        }, converter: {
            toPosition: function (_cf4, size) {
                var opts = $(this).slider("options");
